...
#   default output: ~/Desktop/LimeChain-FRED-v4-proposal-DRAFT.docx
...
OUT="${1:-$HOME/Desktop/LimeChain-FRED-v4-proposal-DRAFT.docx}"
SRC="${PROPOSAL:-proposals/2026-09-LimeChain-FRED-v4.md}"
